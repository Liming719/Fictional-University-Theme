...
/* harmony import */ var _modules_locale__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/locale */ "./src/modules/locale.js");
 // Our modules / classes
...
const locale = new _modules_locale__WEBPACK_IMPORTED_MODULE_4__["default"]();
...
class Locale {
  ...
  async switchLocale() {
    ...
    var res = await axios__WEBPACK_IMPORTED_MODULE_0___default().get(window.location.origin + "/wp-json/university/v1/language?lan=" + this.languageList.value);
  }
...
class Search {
  ...
  async getResults() {
    try {
      const response = await axios__WEBPACK_IMPORTED_MODULE_0___default().get(window.location.origin + "/wp-json/university/v1/search?val=" + this.searchField.value);
  ...
  openOverlay() {
    ...
    setTimeout(() => this.searchField.focus(), 301); //console.log("our open method just ran!")
  ...
  closeOverlay() {
    ...
    document.body.classList.remove("body-no-scroll"); //console.log("our close method just ran!")
